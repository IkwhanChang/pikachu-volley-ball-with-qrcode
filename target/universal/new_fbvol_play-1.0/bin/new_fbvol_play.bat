@REM new_fbvol_play launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM NEW_FBVOL_PLAY_config.txt found in the NEW_FBVOL_PLAY_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%NEW_FBVOL_PLAY_HOME%"=="" set "NEW_FBVOL_PLAY_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%NEW_FBVOL_PLAY_HOME%\lib\"
...
set "CFG_FILE=%NEW_FBVOL_PLAY_HOME%\NEW_FBVOL_PLAY_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running new_fbvol_play.
  echo.
